...
class BattleshipModelTest {
    ...
    void shootAtComputer() {
        ...
        model.shootAtComputer(5,1) ;
        assertEquals(5, model.computerHits.get(2).getAcross());
        assertEquals(1, model.computerHits.get(2).getDown());
        assertEquals(5, model.computerHits.get(3).getAcross());
        assertEquals(2, model.computerHits.get(3).getDown());
        assertEquals(5, model.computerHits.get(4).getAcross());
        assertEquals(3, model.computerHits.get(4).getDown());

        model.shootAtComputer(9,6) ;
        assertEquals(9, model.computerHits.get(5).getAcross());
        assertEquals(6, model.computerHits.get(5).getDown());

        model.shootAtComputer(10,10) ;
        assertEquals(10, model.computerHits.get(6).getAcross());
        assertEquals(10, model.computerHits.get(6).getDown());
    }
